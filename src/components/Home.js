...
import './Home.css';
import skill from './hackimages/skill.png';
...
const TypewriterEffect = ({ text }) => {
  ...
  useEffect(() => {
    ...
    }, 150); // Adjust typing speed by changing this interval
            ...
            <div className="container">
              ...
              <motion.h2
                ...
                <form className="form-inline">
                  ...
                  <button type="submit" className="btn btn-md btn-success-gradiant text-white border-0 mb-2" onClick={redirect}>Get Started</button>
                </form>
              </div>
            </div>
            <div
              className="col-md-4 bg-img" style={{backgroundImage:`url(${skill})`,height:"109vh",width:"130vh"}}>
